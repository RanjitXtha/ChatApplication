...
const ChatSection = ({onlineUserIds}) => {
...
console.log(currentUser.userId+ ' '+ contact._id)
...
console.log('message set')
  ...
  setPreview(null);
    ...
    socket.emit('sendMessage',{
      _id: sentMessage._id, // optional
      content: sentMessage.content,
      senderId: sentMessage.senderId,
      recieverId: sentMessage.recieverId,
      image: sentMessage.image || null, // URL of uploaded image
      createdAt: sentMessage.createdAt, // if needed
    });
  } catch (err) {
