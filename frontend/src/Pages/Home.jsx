...
const Home = () => {
  ...
  return (
    <div className="grid grid-cols-[1fr_3fr] h-screen  ">
      ...
      {
        currentChatUser ?
          <ChatSection setUnreadMessages={setUnreadMessages} unreadMessages={unreadMessages} /> : <div className='bg-gray-800 text-white border-b border-gray-700 p-4'>Select user to start chatting.....</div>
      }
