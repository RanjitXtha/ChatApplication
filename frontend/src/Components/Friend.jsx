...
const Friend = ({ user, listType ,unreadCount}) => {
  ...
  const handleCurrentChatUser = (user) => {
    ...
    dispatch(setCurrentChatType("user"));
  ...
  return (
    <div onClick={() => handleCurrentChatUser(user)}
      className={`p-4 mx-3 my-1 rounded-2xl cursor-pointer transition-all duration-200 hover:bg-gray-700 ${currentChatId === user._id
